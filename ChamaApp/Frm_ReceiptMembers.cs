...
namespace ChamaApp
{
    public partial class Frm_ReceiptMembers : Form
    {
        ...
        {
            CashBookList = SqliteDataAccess.GetCashBookByMemberId(Member_Id);
        ...
        private void dtgMemberReceipts_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            dtpTransDate.Value = Convert.ToDateTime(dtgrow.Cells[2].Value.ToString());
            cboPayMode.Text = dtgrow.Cells[3].Value.ToString();
